...
PAIRS = [
    ...
    ('feedback-success-on-solid', 'feedback-success-default', 4.5, 'success action label (default)'),
    ('feedback-success-on-solid', 'feedback-success-hover', 4.5, 'success action label (hover)'),
    ('feedback-success-on-solid', 'feedback-success-pressed', 4.5, 'success action label (pressed)'),
    ('feedback-warning-on-solid', 'feedback-warning-default', 4.5, 'warning action label (default)'),
    ('feedback-warning-on-solid', 'feedback-warning-hover', 4.5, 'warning action label (hover)'),
    ('feedback-warning-on-solid', 'feedback-warning-pressed', 4.5, 'warning action label (pressed)'),
    ('feedback-danger-on-solid', 'feedback-danger-default', 4.5, 'danger action label (default)'),
    ('feedback-danger-on-solid', 'feedback-danger-hover', 4.5, 'danger action label (hover)'),
    ('feedback-danger-on-solid', 'feedback-danger-pressed', 4.5, 'danger action label (pressed)'),
    ('feedback-info-on-solid', 'feedback-info-default', 4.5, 'info action label (default)'),
    ('feedback-info-on-solid', 'feedback-info-hover', 4.5, 'info action label (hover)'),
    ('feedback-info-on-solid', 'feedback-info-pressed', 4.5, 'info action label (pressed)'),
